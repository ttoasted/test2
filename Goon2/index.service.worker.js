...
/** @type {string} */
const CACHE_VERSION = '1757903366|582338846';
/** @type {string} */
const CACHE_PREFIX = 'BERGENTRUCK_201X-sw-cache-';
...
/** @type {string[]} */
const CACHEABLE_FILES = ["index.wasm","index.pck","index.side.wasm","libgodot-box2d.web.template_release.wasm32.wasm"];
